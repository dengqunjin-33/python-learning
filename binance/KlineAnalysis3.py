...
def plotImage(array: list, title: str):
...
if __name__ == '__main__':
    ...
    getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 0, 140, 30)
    getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 160, 360, 30)
    getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 385, 705, 30)
    getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 720, 880, 30)
    # 910-990
    # getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 909, 989, 30)
    getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 909, 969, 30)

    # 991-1208
    # getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 990, 1200, 30)
    getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 990, 1170, 30)
    # 1209-1400
    getCorrcoefListForRange(amount_array, vol_array, open_array, close_array, high_array, low_array, 1210, 1350, 30)
    ...
    plotImage(amount_array, 'amount')
    plotImage(vol_array, 'vol')
    plotImage(open_array, 'open')
    plotImage(close_array, 'close')
    plotImage(high_array, 'high')
    plotImage(low_array, 'low')
